...
TEST_BUILD_DIR_NAME = "tests-zmk-module-runtime-accel"
...
class WestCommandsTests(unittest.TestCase):
    ...
    def test_zmk_build(self):
        self._test_zmk_build(
            {
                "runtime_accel_board_feature_disabled": ConfigAndDeviceTree(
                    config=[
                        'CONFIG_ZMK_KEYBOARD_NAME="Module Test"',
                        "CONFIG_ZMK_USB=y",
                        "CONFIG_ZMK_BLE=y",
                        "# CONFIG_ZMK_RUNTIME_ACCEL is not set",
                    ],
                    device=[
                        "DT_COMPAT_HAS_OKAY_zmk_keymap",
                    ],
                ),
                "runtime_accel_board_with_rpc": ConfigAndDeviceTree(
                    config=[
                        "CONFIG_ZMK_STUDIO=y",
